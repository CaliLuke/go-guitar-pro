...
func TestSemanticMatrixM01MetadataImport(t *testing.T) {
	runSemanticMatrixM01MetadataImport(newSemanticMatrixRun(t))
}

func TestSemanticMatrixM01MetadataCorpus(t *testing.T) {
	runSemanticMatrixM01MetadataCorpus(newSemanticMatrixRun(t))
}

func runSemanticMatrixM01MetadataCorpus(run *semanticMatrixRun) {
	tests := []struct {
		path        string
		words       string
		author      string
...
func runSemanticMatrixM01MetadataImport(run *semanticMatrixRun) {
...
func TestSemanticMatrixM01OracleKeepsAuthorAndWriterDistinct(t *testing.T) {
	runSemanticMatrixM01OracleKeepsAuthorAndWriterDistinct(newSemanticMatrixRun(t))
}

func runSemanticMatrixM01OracleKeepsAuthorAndWriterDistinct(run *semanticMatrixRun) {
	t := run.t
...
func TestSemanticMatrixM01BinaryClipboard(t *testing.T) {
	runSemanticMatrixM01BinaryClipboard(newSemanticMatrixRun(t))
}

func runSemanticMatrixM01BinaryClipboard(run *semanticMatrixRun) {
...
func TestSemanticMatrixM01MetadataExportPolicy(t *testing.T) {
	runSemanticMatrixM01MetadataExportPolicy(newSemanticMatrixRun(t))
}

func runSemanticMatrixM01MetadataExportPolicy(run *semanticMatrixRun) {
	t := run.t
	song := semanticM01Song()
