...
func TestConformanceInstrumentContext(t *testing.T) {
	runConformanceInstrumentContext(newConformanceRun(t))
}

func runConformanceInstrumentContext(run *conformanceRun) {
	t := run.t
