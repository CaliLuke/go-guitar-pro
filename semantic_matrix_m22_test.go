...
func TestSemanticMatrixM22MultiStaffContext(t *testing.T) {
	runSemanticMatrixM22MultiStaffContext(newSemanticMatrixRun(t))
}

func runSemanticMatrixM22MultiStaffContext(run *semanticMatrixRun) {
	t := run.t
...
func TestSemanticMatrixM22PickupTupletTempo(t *testing.T) {
	runSemanticMatrixM22PickupTupletTempo(newSemanticMatrixRun(t))
}

func runSemanticMatrixM22PickupTupletTempo(run *semanticMatrixRun) {
	t := run.t
	song := semanticValidPitchedGP8Song(t)
	song.Anacrusis = true
	...
	run.Wire("gpifAutomation.Bar", m17AutomationInts(wire.masterAutomations, func(item m17WireAutomation) int { return item.Bar }), []int{0, 1})
	run.Wire("gpifAutomation.Position", m17AutomationFloats(wire.masterAutomations, func(item m17WireAutomation) float64 { return item.Position }), []float64{0, 0.25})
	run.Wire("gpifAutomation.Value", m17AutomationStrings(wire.masterAutomations, func(item m17WireAutomation) string { return item.Value }), []string{"120 2", "132.5 2"})
	roundTrip, err := Parse(data)
	if err != nil {
		t.Fatal(err)
	}
...
func TestSemanticMatrixM22ChordOccurrence(t *testing.T) {
	runSemanticMatrixM22ChordOccurrence(newSemanticMatrixRun(t))
}

func runSemanticMatrixM22ChordOccurrence(run *semanticMatrixRun) {
	t := run.t
	parsed, err := Parse(conformanceGPIFArchive(t, semanticM14ScopedGPIF))
	if err != nil {
		t.Fatal(err)
	}
...
func TestSemanticMatrixM22GraceCombinations(t *testing.T) {
	runSemanticMatrixM22GraceCombinations(newSemanticMatrixRun(t))
}

func runSemanticMatrixM22GraceCombinations(run *semanticMatrixRun) {
	t := run.t
...
func TestSemanticMatrixM22EffectsAndDynamics(t *testing.T) {
	runSemanticMatrixM22EffectsAndDynamics(newSemanticMatrixRun(t))
}

func runSemanticMatrixM22EffectsAndDynamics(run *semanticMatrixRun) {
	t := run.t
	song := semanticExportProbeSong(t)
	track := &song.Tracks[0]
...
func TestSemanticMatrixM22LyricsPlaybackAutomation(t *testing.T) {
	runSemanticMatrixM22LyricsPlaybackAutomation(newSemanticMatrixRun(t))
}

func runSemanticMatrixM22LyricsPlaybackAutomation(run *semanticMatrixRun) {
	t := run.t
	song := semanticValidPitchedGP8Song(t)
	track := &song.Tracks[0]
...
func TestSemanticMatrixM22BackingSyncTempo(t *testing.T) {
	runSemanticMatrixM22BackingSyncTempo(newSemanticMatrixRun(t))
}

func runSemanticMatrixM22BackingSyncTempo(run *semanticMatrixRun) {
	t := run.t
	song := semanticValidPitchedGP8Song(t)
	song.Tracks[0].Settings.Notation = true
	...
	wire := extractM17WireDocument(t, data)
	run.Wire("gpifAutomation.Value", m17AutomationStrings(wire.masterAutomations, func(item m17WireAutomation) string { return item.Value }), []string{"132.5 2"})
	got, err := Parse(data)
	if err != nil {
		t.Fatal(err)
	}
...
func TestSemanticMatrixM22SelectiveAllowlist(t *testing.T) {
	runSemanticMatrixM22SelectiveAllowlist(newSemanticMatrixRun(t))
}

func runSemanticMatrixM22SelectiveAllowlist(run *semanticMatrixRun) {
	t := run.t
	song := semanticExportProbeSong(t)
...
func TestSemanticMatrixM22LegacyEditAuthority(t *testing.T) {
	runSemanticMatrixM22LegacyEditAuthority(newSemanticMatrixRun(t))
}

func runSemanticMatrixM22LegacyEditAuthority(run *semanticMatrixRun) {
	t := run.t
