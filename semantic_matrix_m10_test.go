...
func TestSemanticMatrixM10BeatSemantics(t *testing.T) {
	runSemanticMatrixM10BeatSemantics(newSemanticMatrixRun(t))
}

func runSemanticMatrixM10BeatSemantics(run *semanticMatrixRun) {
	t := run.t
...
func TestSemanticMatrixM10BeatEffects(t *testing.T) {
	runSemanticMatrixM10BeatEffects(newSemanticMatrixRun(t))
}
