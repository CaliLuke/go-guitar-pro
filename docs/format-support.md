...
| `percussion-articulations` | gp7, gp8 | supported | none | GP7–8 GPIF articulation identity, per-track definitions, notation metadata, input values, and output MIDI agree with AlphaTab; older format mappings are outside this feature scope. |
