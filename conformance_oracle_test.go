...
func TestConformanceOracleCorrectness(t *testing.T) {
	runConformanceOracleCorrectness(newConformanceRun(t))
}

func runConformanceOracleCorrectness(run *conformanceRun) {
	run.t.Run("comparator sensitivity", testOracleComparatorSensitivity)
	run.t.Run("Go adapters", testOracleGoAdapterContracts)
}

func testOracleComparatorSensitivity(t *testing.T) {
	...
	baseline := conformanceOracleOwnershipProbe(61, 73)
	swapped := conformanceOracleOwnershipProbe(73, 61)
	...
	regular := conformanceOracleBeatProbe("none")
	ottava := conformanceOracleBeatProbe("8va")
...
func testOracleGoAdapterContracts(t *testing.T) {
	checks := []struct {
		name string
		got  string
		want string
...
func conformanceOracleOwnershipProbe(first, second int) any {
...
func conformanceOracleBeatProbe(octave string) any {
	return map[string]any{"tracks": []any{map[string]any{
